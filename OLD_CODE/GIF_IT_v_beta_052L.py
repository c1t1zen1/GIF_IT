...
icon = tk.PhotoImage(master=window, file='icon_16.png')
...
resample_value_entry = tk.Entry(resample_frame, textvariable=resample_value, bg='powder blue', relief='flat', font=('TkDefaultFont', 9, 'bold'))
...
colors_value_entry = tk.Entry(colors_frame, textvariable=colors_value, bg='powder blue', relief='flat', font=('TkDefaultFont', 9, 'bold'))
colors_value_entry.grid(row=0, column=1)

colors_slider = ttk.Scale(window, from_=1, to=256, length=125, style="blue.Horizontal.TScale", command=lambda value: colors_value.set("{:.0f}".format(float(value))))
