...
def create_gif_from_images(folder_path, output_folder, output_name, speed=100, dissolve=0):
    images = []
...
def create_gif(folder_path=None):
    ...
    if folder_path:
        ...
        create_gif_from_images(folder_path, output_folder, output_name, gif_speed, dissolve)
